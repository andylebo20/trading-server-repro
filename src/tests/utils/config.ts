...
let path: string = env.CONFIG ?? "./src/tests/config.json";
path = fs.existsSync(path) ? path : "./src/tests/config_default.json";

const configRAW: Readonly<IConfig> = JSON.parse(
